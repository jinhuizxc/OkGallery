...
public class PhotoPickerActivity extends PhotoBaseActivity implements OkGalleryAsyncTask.Callback<ArrayList<ImageFolder>>, BGAOnItemChildClickListener {
    ...
    public void onClick(View v) {
        ...
        } else if ((v.getId() == R.id.tv_title || v.getId() == R.id.iv_arrow)
                && mImageFolders != null && mImageFolders.size() > 0
                && System.currentTimeMillis() - mLastShowPhotoFolderTime > PhotoFolderPw.ANIM_DURATION) {
            showPhotoFolderPw();
